...
test_data, test_label = load_data(["./data/Test/Set5/3"], lrs_size[0], lrs_size[1], factor=factor, size=500, channel=channel, boarder_loss=boarder_loss)
...
solve_net(model, train_data, train_label, test_data, test_label,
          batch_size=128, max_epoch=1000000, disp_freq=10, test_freq=100,
